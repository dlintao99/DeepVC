'''
@file s2vt.py: the implementation of S2VT model with two layers.
...
class S2VT_twolayers(nn.Module):
    ...
    def __init__(self, 
        ...
        super(S2VT_twolayers, self).__init__()
        ...
        self.LSTM_unit_l1 = nn.LSTMCell(self.dim_embedded_frame_feature + self.dim_embedded_word, self.dim_hidden_state)
        self.LSTM_unit_l2 = nn.LSTMCell(self.dim_embedded_frame_feature + self.dim_embedded_word, self.dim_hidden_state)
