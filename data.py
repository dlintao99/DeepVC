...
def get_train_loader(cap_pkl, feature_h5, batch_size=100, shuffle=True, num_workers=3, pin_memory=True):
...
def get_eval_loader(cap_pkl, feature_h5, batch_size=100, shuffle=False, num_workers=1, pin_memory=False):
